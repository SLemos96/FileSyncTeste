...
public class FileSystemModel implements TreeModel, Serializable{
 ...
 /*       for (int j = 0; j< children.length; j++ ){
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        fsm = new FileSystemModel(new File(System.getProperty("file.separator")));                
        
        try {
            oos = new ObjectOutputStream(new FileOutputStream(caminho + "fsmBytes"));
            oos.writeObject(fsm);                        
            oos.close();
            
            //in = new ObjectInputStream(new FileInputStream(caminho + "fsmBytes"));
            //fsm = (FileSystemModel) in.readObject();
            //new EscolhaDiretorio(null, fsm, true);
