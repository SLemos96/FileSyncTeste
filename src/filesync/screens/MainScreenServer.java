...
import filesync.server.Request;
import java.io.File;
...
public class MainScreenServer extends javax.swing.JFrame {
        ...
        try {
            ...
            while (true) {
                ...
                if (req.type == false) {
                    ...
                    File choose = new File(req.path.getAbsolutePath());
    ...
    public void conecta_label(String ip, String porta) {
        jLabel1.setText("conectado a " + ip + " porta " + porta);
    }
    ...
    private ArrayList preenche(File choose) {

        ArrayList absolute = new ArrayList();

        FilenameFilter filtro = (File arquivo, String nome) -> nome.toLowerCase().endsWith(".pdf")
                ...
                || nome.toLowerCase().endsWith(".avi")
                || nome.toLowerCase().endsWith(".rmvb");

        for (File arquivo : choose.listFiles(filtro)) {
            if (arquivo.isFile()) {
                absolute.add(arquivo);
            } else {
